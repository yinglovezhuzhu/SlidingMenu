...
public class TestFragment4 extends Fragment {
	...
	private static final String TAG = TestFragment4.class.getSimpleName();
	...
	public static TestFragment4 newInstance(String title) {
		final TestFragment4 f = new TestFragment4();
