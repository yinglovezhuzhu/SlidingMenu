...
public class TestFragment8 extends Fragment {
	...
	private static final String TAG = TestFragment8.class.getSimpleName();
	
	private static final String ARGS_TITLE = "title";
	
	public static TestFragment8 newInstance(String title) {
		final TestFragment8 f = new TestFragment8();
