...
public class TestFragment5 extends Fragment {
	...
	private static final String TAG = TestFragment5.class.getSimpleName();
	
	private static final String ARGS_TITLE = "title";
	
	public static TestFragment5 newInstance(String title) {
		final TestFragment5 f = new TestFragment5();
